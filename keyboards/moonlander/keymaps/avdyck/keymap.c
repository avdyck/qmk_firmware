...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = LAYOUT_moonlander(
        ...
        TABBB,    KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     C(KC_INS),           TG(NUM),  KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_BSPC,
        ESCAP,    KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     S(KC_INS),           KC_INS,   KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_ENTER,
        SJIFT,    KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,                                    KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,
    ...
    [NAV] = LAYOUT_moonlander(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,             _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  KC_F9,    KC_F8,    KC_F7,    KC_F10,   _______,             _______,  _______,  KC_HOME,  KC_UP,    KC_END,   _______,  _______,
        _______,  _______,  KC_F6,    KC_F5,    KC_F4,    KC_F11,   _______,             _______,  CG_LEFT,  KC_LEFT,  KC_DOWN,  KC_RIGHT, CG_RIGHT, _______,
        _______,  _______,  KC_F3,    KC_F2,    KC_F1,    KC_F12,                                  _______,  KC_PGDN,  _______,  KC_PGUP,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,                                 _______,  _______,  _______,  _______,  _______,  _______,
                                                _______,  _______,  _______,             _______,  _______,  _______
    ),
